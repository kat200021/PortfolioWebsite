...
const Footer = () => {
  ...
  const socialLinks = [
    {
      name: 'GitHub',
      url: 'https://github.com/kat200021',
      icon: (
    ...
    {
      name: 'LinkedIn',
      url: 'https://www.linkedin.com/in/shreyakatanguru/',
      icon: (
        <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
          <path
      ...
      <div className="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div className="col-span-1">
            ...
            <ul className="mt-4 space-y-2">
              <li>
                <Link to="/" className="text-base text-gray-600 dark:text-gray-400 hover:text-primary">
                  Home
                </Link>
              </li>
              <li>
                <Link to="/about" className="text-base text-gray-600 dark:text-gray-400 hover:text-primary">
                  About
                </Link>
              </li>
              <li>
                <Link to="/projects" className="text-base text-gray-600 dark:text-gray-400 hover:text-primary">
                  Projects
                </Link>
              </li>
              <li>
          ...
          <div className="col-span-1">
            ...
            <div className="mt-4">
              <a href="mailto:your.email@example.com" className="text-base text-gray-600 dark:text-gray-400 hover:text-primary">
                katangurushreya@gmail.com
              </a>
            </div>
          </div>
        </div>
        ...
        <div className="mt-12 border-t border-gray-200 dark:border-gray-700 pt-8 flex flex-col md:flex-row justify-between items-center">
          <p className="text-base text-gray-500 dark:text-gray-400">
            &copy; {currentYear} Shreya Reddy. All rights reserved.
          </p>
